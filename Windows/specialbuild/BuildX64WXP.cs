// builds StartWaitTree on Windows XP 64-bit
// using Visual C++ 2005 and the Windows Server 2003 SP1 Platform SDK
//
...
static class BuildI386W2k
{
    ...
    static void ObtainEnvironment()
    {
        ...
        string programFiles32 = GetProgramFilesX86();
        PathEnvirons["Include"] = string.Format("{0}\\Microsoft Visual Studio 8\\VC\\include;{1}\\Microsoft Platform SDK\\Include;{1}\\Microsoft Platform SDK\\Include\\crt", programFiles32, programFiles64);
        PathEnvirons["Lib"] = string.Format("{0}\\Microsoft Visual Studio 8\\VC\\lib\\amd64;{1}\\Microsoft Platform SDK\\Lib\\AMD64", programFiles32, programFiles64);

        // Path must be appended to our environment, not just children's environments
        string appendPath = string.Format("{0}\\Microsoft Visual Studio 8\\VC\\bin\\amd64;{1}\\Microsoft Platform SDK\\Bin", programFiles32, programFiles64);
    ...
    {
        // System.Environment.SpecialFolder.ProgramFilesX86 does not yet exist in .NET Framework 2.0
